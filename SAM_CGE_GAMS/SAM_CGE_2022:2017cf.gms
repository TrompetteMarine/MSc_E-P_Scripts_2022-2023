$title counterfactual CGE model for aggregated Households for the year 2022 based on 2017 prices adjusted for inflation if the Macro-inflation rate followed the EU 2% objective
...
* savings
eqSp..      Sp     =e= ssp*sum(h, (pf(h)/(1.268))*FF(h));
