$title counterfactual CGE model for aggregated Households for the year 2023 based on 2017 prices adjusted for the observed Macro-inflation rate
...
* savings
eqSp..      Sp     =e= ssp*sum(h, (pf(h)/(1.465))*FF(h));
